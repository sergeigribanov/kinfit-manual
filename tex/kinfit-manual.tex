...
\begin{frame}{$e^+e^-\rightarrow{\rm K}_{\rm S}{\rm K}_{\rm L}\pi^0$}
  ...
  \begin{frame}{Настройка окружения}
    ...
    или скопировать содержимое этого файла в уже имеющийся rootlogon.C. \textit{Пример}\\
  ...
  \begin{frame}{Устройство гипотезы $K_sK^-\pi^+,\,K_s\rightarrow\pi^+\pi^-$}
   ...
   \begin{frame}{Создание собственной гипотезы}
   \end{frame}

  \begin{frame}{Использование пакета KFCmd}
  \end{frame}
